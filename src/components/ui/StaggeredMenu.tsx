...
const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    position = 'right',
    colors = ['#1a202c', '#2d3748'], // Default fallbacks
    items = [],
    socialItems = [],
    displaySocials = true,
                        ...
                        {items && items.length ? (
                            items.map((it, idx) => (
                                <li className="sm-panel-itemWrap" key={it.label + idx}>
                                    <Link className="sm-panel-item" href={it.link} aria-label={it.ariaLabel || it.label} data-index={idx + 1} onClick={closeMenu}>
                    ...
                    {displaySocials && socialItems && socialItems.length > 0 && (
                        <div className="sm-socials" aria-label="Social links">
                            <ul className="sm-socials-list" role="list">
                                {socialItems.map((s, i) => (
                                    <li key={'social_' + i} className="sm-socials-item">
